        ...
        while len(games) <= count:
            ...
            for content in contents:
                ...
                game = {"game_name": '', "introduction": '', "hardware_need": '', "platform": [], "type": [],
                        ...
                        "platform_logo_path": 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSz5a2en57kSi_HD40xkUFwU-FlsUk1kjCzLmCKQmVCkA&s'}
...
def OceanOfGames(count):
    games: list = crawl(count)
    while not games:
        crawl()
    return games
